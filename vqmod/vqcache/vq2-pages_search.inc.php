...
<?php
  ...
  $query =
    "select p.*, pi.name, pi.short_description, pi.date_valid_from_closing, pi.date_valid_to_closing, pi.medium_description, pi.costing_information, pi.oversize_parcel, pi.medium_parcel, pi.small_parcel, pi.opening_quantity, pi.listing_info, pi.box_conditions, pi.guess_price, pi.shopee, pi.lazada,
 pwl.wishable, 
			 m.name as manufacturer_name, pp.price, ppbdp.default_price_price, ppbgp.guest_price_price, ppbwp.wholesale_price_price, ppsip.sign_in_date_price_price, ppfsp.fake_sold_out_date_price_price, psqp.stock_quantity_price, psqgp.stock_quantity_guest_price,  ppbcg.customer_group_price,  pc.campaign_price, if(pc.campaign_price, pc.campaign_price, if(pc.campaign_price, pc.campaign_price, pp.price)) as final_price,
    (

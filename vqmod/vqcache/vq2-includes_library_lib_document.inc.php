<?php
  ...
  class document {
    ...
    public static function init() {
      ...
      isset($_GET['items_limit'])?settings::set('items_per_page', $_GET['items_limit']):'';
    ...
    // Set some snippets
      ...
      self::$snippets['head_tags']['trueresponsivecheckout'] = '<link rel="stylesheet" href="'. WS_DIR_EXT .'tablesaw/tablesaw.css" />';
      

      self::$snippets['foot_tags']['trueresponsivecheckout'] = '<script src="'. WS_DIR_EXT .'tablesaw/tablesaw.stackonly.jquery.js"></script>';

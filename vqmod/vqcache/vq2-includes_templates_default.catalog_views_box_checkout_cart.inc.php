...
<section id="box-checkout-cart" class="box">
  ...
  <div class="table-responsive">
    <table data-tablesaw-mode="stack" class="tablesaw tablesaw-stack items table table-striped table-hover data-table">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr class="item" data-id="<?php echo $item['product_id']; ?>" data-sku="<?php echo $item['sku']; ?>" data-name="<?php echo htmlspecialchars($item['name']); ?>" data-price="<?php echo currency::format_raw($item['price']); ?>" data-quantity="<?php echo currency::format_raw($item['quantity']); ?>">
          ...
          <td><span class="mobile-price-unit"><?php echo language::translate('display_price_unit', 'Unit price:'); ?> </span><?php echo currency::format($item['display_price']); ?></td>
          <td><span class="mobile-price-sum"><?php echo language::translate('display_price_sum', 'Sum:'); ?> </span><?php echo currency::format($item['display_price'] * $item['quantity']); ?></td>

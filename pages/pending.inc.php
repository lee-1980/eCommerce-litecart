<?php
  ...
  document::$snippets['title'][] = language::translate('title_pending', 'Pending');

  breadcrumbs::add(language::translate('title_backorder', 'pending'), document::ilink('pending'));
  ...
  echo $_page->stitch('pages/pending');

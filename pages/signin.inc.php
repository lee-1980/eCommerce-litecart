<?php
  ...
  document::$snippets['title'][] = language::translate('title_signin', 'Sign-In');

  breadcrumbs::add(language::translate('title_signin', 'Sign-In'), document::ilink('signin'));
  ...
  echo $_page->stitch('pages/signin');

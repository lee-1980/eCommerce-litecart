<?php
  ...
  document::$snippets['title'][] = language::translate('title_restock', 'Restock');

  breadcrumbs::add(language::translate('title_restock', 'Restock'), document::ilink('restock'));
  ...
  echo $_page->stitch('pages/restock');

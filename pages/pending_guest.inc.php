<?php
  ...
  document::$snippets['title'][] = language::translate('title_pending_guest', 'Pending Guest');

  breadcrumbs::add(language::translate('title_pending_guest', 'Pending Guest'), document::ilink('pending_guest'));
  ...
  echo $_page->stitch('pages/pending_guest');

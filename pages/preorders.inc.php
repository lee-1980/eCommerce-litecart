<?php
  ...
  document::$snippets['title'][] = language::translate('title_preorders', 'Pre-Orders');

  breadcrumbs::add(language::translate('title_preorders', 'Pre-Orders'), document::ilink('preorders'));
  ...
  echo $_page->stitch('pages/preorders');

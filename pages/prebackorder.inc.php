<?php
  ...
  document::$snippets['title'][] = language::translate('title_prebackorder', 'Pre-Orders');

  breadcrumbs::add(language::translate('title_prebackorder', 'Pre-Backrder'), document::ilink('prebackorder'));
  ...
  $query =
    ...
    from (
      ...
      where status
      and prebackorder
      and (date_valid_to > '". date('Y-m-d H:i:s') ."')
    ) p
  ...
  echo $_page->stitch('pages/prebackorder');

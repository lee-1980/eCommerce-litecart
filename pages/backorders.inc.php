<?php
  ...
  document::$snippets['title'][] = language::translate('title_backorder', 'Backorder');

  breadcrumbs::add(language::translate('title_backorder', 'Backorder'), document::ilink('backorder'));
  ...
  echo $_page->stitch('pages/backorder');

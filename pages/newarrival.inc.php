<?php
  ...
  document::$snippets['title'][] = language::translate('title_newarrival', 'New Arrival');

  breadcrumbs::add(language::translate('title_newarrival', 'New Arrival'), document::ilink('newarrival'));
  ...
  echo $_page->stitch('pages/newarrival');

<?php
  ...
  document::$snippets['title'][] = language::translate('title_hide_product', 'Hide Product');

  breadcrumbs::add(language::translate('title_hide_product', 'Hide Product'), document::ilink('hide_product'));
  ...
  echo $_page->stitch('pages/hide_product');

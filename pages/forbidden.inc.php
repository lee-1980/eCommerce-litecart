<?php
  ...
  document::$snippets['title'][] = language::translate('title_forbidden', 'Forbidden');

  breadcrumbs::add(language::translate('title_forbidden', 'Forbidden'), document::ilink('forbidden'));
  ...
  echo $_page->stitch('pages/forbidden');

<?php
  ...
  document::$snippets['title'][] = language::translate('title_hidden', 'Hidden');

  breadcrumbs::add(language::translate('title_hidden', 'Hidden'), document::ilink('hidden'));
  ...
  echo $_page->stitch('pages/hidden');

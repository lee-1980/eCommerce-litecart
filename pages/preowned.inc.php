<?php
  ...
  document::$snippets['title'][] = language::translate('title_preowned', 'Pre Owned');

  breadcrumbs::add(language::translate('title_preowned', 'Pre Owned'), document::ilink('preowned'));
  ...
  echo $_page->stitch('pages/preowned');

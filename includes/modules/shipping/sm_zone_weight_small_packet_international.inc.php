<?php
  ...
  class sm_zone_weight_small_packet_international {
    public $id = __CLASS__;
        ...
        $options[] = array(
          ...
          'description' => null,
           'fields' => '<div dir="ltr" style="text-align: left;" trbidi="on"><table auto="" border="0" cellpadding="3" cellspacing="0" style="font-family: verdana, arial, helvetica, sans-serif;"><tbody>
                       ...
                       <tr align="left"><td valign="top"><span style="color: black;">Estimated Delivery Time</span></td><td valign="top"><span style="color: black;">:</span></td><td valign="top">6 to 11 days</td></tr>
                       </tbody></table>
                       </div>',
          'cost' => $cost,

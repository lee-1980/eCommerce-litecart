<?php
  ...
  class sm_zone_weight_line_clear_malaysia {
    public $id = __CLASS__;
    ...
    public function __construct() {
      $this->name = language::translate(__CLASS__.':title_line_clear', 'Line Clear Express');
    }
    ...
    // Calculate cart weight
      ...
      foreach ($items as $item) {
        //   var_dump($item);
       $oversize_parcel_weight = self::calculate_oversize_parcel_weight($item['dim_x'],$item['dim_y'],$item['dim_z'],$item['dim_class']);
       $total_weight += weight::convert($item['quantity'] * (!empty($oversize_parcel_weight) && $oversize_parcel_weight * $item['quantity'] > 5 ? $oversize_parcel_weight:$item['weight']), $item['weight_class'], $this->settings['weight_class']);
      }
    ...
    private function calculate_oversize_parcel_weight( $dim_x = 0, $dim_y = 0, $dim_z = 0, $dim_class = "cm") {
      ...
      $weight = (length::convert($dim_x, $dim_class, "cm") + 1.5 ) * (length::convert($dim_y, $dim_class, "cm") + 1.5 ) * (length::convert($dim_z, $dim_class, "cm") + 1.5 ) / 6000;
    ...
    public function settings() {
      return array(
        ...
        array(
          'key' => 'geo_zone_id_2',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 2: '. language::translate(__CLASS__.':title_geo_european_union', 'European Union'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(
          ...
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 2: '. language::translate(__CLASS__.':title_weight_rate_geo_european_union', 'European Union'),
          'description' => language::translate(__CLASS__.':description_weight_rate_table', 'Ascending rate table of the shipping cost. The format must be weight:cost;weight:cost;.. (E.g. 3:8.93;10:13.93;..)'),
          'function' => 'input()',
        ), 
        array(
          'key' => 'geo_zone_id_3',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 3: '. language::translate(__CLASS__.':title_geo_united_kingdom', 'United Kingdom'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(
          ...
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 3: '. language::translate(__CLASS__.':title_weight_rate_geo_united_kingdom', 'United Kingdom'),
          'description' => language::translate(__CLASS__.':description_weight_rate_table', 'Ascending rate table of the shipping cost. The format must be weight:cost;weight:cost;.. (E.g. 5:8.95;10:15.95;..)'),
          'function' => 'input()',
        ),         
        ...
        array(
          'key' => 'geo_zone_id_4',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 4: '. language::translate(__CLASS__.':title_geo_singapore', 'Singapore'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(
          ...
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 4: '. language::translate(__CLASS__.':title_weight_rate_geo_singapore', 'Singapore'),
          'description' => language::translate(__CLASS__.':description_weight_rate_table', 'Ascending rate table of the shipping cost. The format must be weight:cost;weight:cost;.. (E.g. 5:8.95;10:15.95;..)'),
          'function' => 'input()',
        ), 
        array(
          'key' => 'geo_zone_id_5',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 5: '. language::translate(__CLASS__.':title_geo_thailand', 'Thailand'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(
          ...
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 5: '. language::translate(__CLASS__.':title_weight_rate_geo_thailand', 'Thailand'),
          'description' => language::translate(__CLASS__.':description_weight_rate_table', 'Ascending rate table of the shipping cost. The format must be weight:cost;weight:cost;.. (E.g. 5:8.95;10:15.95;..)'),
          'function' => 'input()',
        ), 
        array(
          'key' => 'geo_zone_id_6',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 6: '. language::translate(__CLASS__.':title_geo_japan', 'Japan'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(
          ...
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 6: '. language::translate(__CLASS__.':title_weight_rate_geo_japan', 'Japan'),
         ...
         array(
          'key' => 'geo_zone_id_7',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 7: '. language::translate(__CLASS__.':title_geo_australia', 'Australia'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(
          ...
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 7: '. language::translate(__CLASS__.':title_weight_rate_geo_australia', 'Australia'),
         ...
         array(
          'key' => 'geo_zone_id_8',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 8: '. language::translate(__CLASS__.':title_geo_uae', 'United Arab Emirates'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(
          ...
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 8: '. language::translate(__CLASS__.':title_weight_rate_geo_uae', 'United Arab Emirates'),
        ...
        array(
          'key' => 'geo_zone_id_9',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 9: '. language::translate(__CLASS__.':title_geo_china', 'China'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(
          ...
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 9: '. language::translate(__CLASS__.':title_weight_rate_geo_china', 'China'),

<?php
  ...
  class sm_zone_weight_packaging_10 {
    public $id = __CLASS__;
    ...
    // Calculate cart weight
      ...
      for ($i=1; $i <= 16; $i++) {
        ...
        $options[] = array(
          ...
          'description' => null,
          'fields' => 'Request to pack parcel only, use your own courier service to ship parcel out',
          'cost' => $cost,
    ...
    public function settings() {
      return array(
        ...
        array(
          'key' => 'geo_zone_id_1',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_whole_malaysia', 'Whole  Malaysia') .' 1: '. language::translate(__CLASS__.':title_geo_zone', 'Geo Zone'),
        ...
        array(
          ...
          'title' => language::translate(__CLASS__.':title_whole_malaysia', 'Whole  Malaysia') .' 1: '. language::translate(__CLASS__.':title_weight_rate_table', 'Weight Rate Table'),

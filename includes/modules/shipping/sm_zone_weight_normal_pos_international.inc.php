<?php
  ...
  class sm_zone_weight_normal_pos_international {
    public $id = __CLASS__;
    public $name = 'Weight Based Shipping by Zone International';
    public $description = '';
    ...
    public function settings() {
      return array(
        ...
        array(
          'key' => 'geo_zone_id_1',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zone', 'Zone') .' 1: '. language::translate(__CLASS__.':title_geo_usa', 'U.S.A'),
        ...
        array(
          'key' => 'geo_zone_id_2',
          'default_value' => '',
          'title' => language::translate(__CLASS__.':title_zusa', 'Zone') .' 2: '. language::translate(__CLASS__.':title_geo_european_union', 'European Union'),
          'description' => language::translate(__CLASS__.':description_geo_zone', 'Geo zone to which the cost applies.'),
          'function' => 'geo_zones()',
        ),
        array(

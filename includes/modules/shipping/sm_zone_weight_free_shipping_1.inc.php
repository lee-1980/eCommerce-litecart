<?php
  ...
  class sm_zone_weight_free_shipping_1 {
    public $id = __CLASS__;
 ...
 //   $payment_due = session::$data['order']->data["payment_due"] ;
    ...
    // Calculate cart weight
      ...
      if(isset(reference::product($item['product_id'])->no_free_shipping)) return;
      if(isset(reference::product($item['product_id'])->campaign['price'])) return;
      if(isset(reference::product($item['product_id'])->vip)) return;

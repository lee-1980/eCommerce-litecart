      ...
      $method = array(
        ...
        'options' => array(
          array(
            ...
            'name' => '50% Deposit',
            'description' => '<b>Bank Transfer 50% Deposit within 24 hours upon email notification on payment request</b>',
            'cost' => '0.00001',
            'fields' => 'Pay 50% deposit now and the balance within 3 working days upon item arrival email notification. Failing so, your deposit will be forfeited. 
            Any plea will not be entertained.',
